...
Track live matches, detailed scorecards, and ball-by-ball commentary without leaving your coding workflow.  
Perfect for cricket fans who don’t want browser distractions while coding.

### Features
- 🏏 Live matches list with real-time scores
- 📊 Full scorecards with batting & bowling tables
- 🗣️ Ball-by-ball commentary view
- 🔄 Manual refresh when scorecard is available
- 🌐 Quick link to Cricbuzz for full coverage
...
- Using the IDE built-in plugin system:
  ...
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>Marketplace</kbd> > <kbd>Search for "CodeCricket"</kbd> >
  <kbd>Install</kbd>
